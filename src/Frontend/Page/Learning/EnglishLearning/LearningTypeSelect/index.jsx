...
import Shengcishengju from 'Page/Learning/EnglishLearning/Shengcishengju';
        ...
        {this.state.typeselect ? <div>
          <div className = {style.fangkuang1}>
            ...
            <div className = {TextStyle[0]}
                 ...
                 onClick = {() => this.setState({typeselect: false , yuedu: true , shengcishengju: false , chtoeng: false })}>
                 点击进入<br/>英语阅读
            </div>
          </div>
          ...
          <div className = {style.fangkuang2}>
            ...
            <div  className = {TextStyle[1]}
                  ...
                  onClick = {() => this.setState({typeselect: false , yuedu: false , shengcishengju: true , chtoeng: false })}>
                   点击进入<br/>生词生句
            </div>
          </div>
          ...
          <div className = {style.fangkuang3}>
            ...
            <div className = {TextStyle[2]}
                 ...
                 onClick = {() => this.setState({typeselect: false , yuedu: false , shengcishengju: false , chtoeng: true })}>
                 点击查看<br/>汉译英
            </div>
          </div>
        </div>:
        this.state.yuedu ? <YueDu/>:
        this.state.shengcishengju ? <Shengcishengju/>:
