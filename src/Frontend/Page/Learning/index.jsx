...
const Shengcishengju = asyncLoad( () => import( 'EnglishLearning/Shengcishengju' ) );
      ...
      return (
        <React.Fragment>
          <Switch>
            ...
            <Route exact path={`${match.url}/english/shengcishengju`} component={Shengcishengju} />
            <Route exact path={`${match.url}/english/engreview`} component={Shengcishengju} />
